...
Sth-matters笔记目录搭建中，参考融合了茶芒同学的中图法分类，并根据个人对笔记文章的理解，在原分类法基础上进行了一些修改，将其替代笔记之前的答集目录（旧目录见附录）。目前一阶段工程基本完成，之后会随着每周更新持续扩充。
...
具体的分类逻辑：比如答主的一篇文章同时属于家族答集和社科答集，我会根据文章从属的权重放在权重高的那一个答集下面。所以有一定的我的主观决策在里面。
